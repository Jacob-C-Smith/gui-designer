...
static const char *submit_button_name       = "button_submit",
                  *label_input_name         = "button_text_input",
                  *x_input_name             = "button_x_input",
                  *y_input_name             = "button_y_input",
	              *name_input_name          = "button_name_input",
				  *text_label               = "button_text",
				  *x_label                  = "button_x",
				  *y_label                  = "button_y",
				  *name_label               = "button_name";
extern UIWindow_t *target;

void button_constructor_submit_callback ( UIButton_t *button, mouse_state_t mouse )
{
	// Initialized data
	...
	append_element_to_window(target, construct_element (name, construct_button(text, atoi(x), atoi(y)), UI_BUTTON));
...
int button_constructor_dialog ( UIInstance_t *instance, UIWindow_t *target )
{
	// Argument check
	{
		#ifndef NDEBUG
	...
	UIWindow_t  *dialog                = load_window("G UI Designer/button constructor.json");
	...
	add_click_callback_button(submit_button, &button_constructor_submit_callback);
